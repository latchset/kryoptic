...
A PKCS#11 token uses a storage cmponent to save keys.
...
felxibly defined by wrapping the keys and encrypted values using PKCS#5 like
ASN.1 structures.
...
- AAD: The attribute type reprensented as little endian u32
