...
/// Ths is a generic container for all PKCS#11 Objects
/// For Key objects it is possible to set the zeroize feature which
/// will cause zeroization of evry attribute when the object is dropped.
...
impl Object {
    ...
    /// is an inrternal cache that is not stored in the databases.
...
/// sepcific object/key type, and any special behaviors for object
...
///
/// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203218](Data Objects)
/// (Version 3.1)
...
/// CKO_CERTIFICATE
///
/// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203221](Certificate objects)
/// (Version 3.1)
...
///
/// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203224](X.509 public key certificate objects)
/// (Version 3.1)
...
///
/// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203227](Key objects)
/// (Version 3.1)
...
/// CKO_PUBLIC_KEY
///
/// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203230](Public key objects)
/// (Version 3.1)
...
/// CKO_PRIVATE_KEY
///
/// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203231](Private key objects)
/// (Version 3.1)
...
/// CKO_SECRET_KEY
///
/// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203232](Secret key objects)
/// (Version 3.1)
...
///
/// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203468(Generic secret key)
/// (Version 3.1)
...
impl Mechanism for GenericSecretKeyMechanism {
    ...
    /// Implements the Generic Secret Key Geneation
    ///
    /// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203471](Generic secret key generation)
    /// (Version 3.1)
...
impl ObjectFactories {
    ...
    /// for setting the ulValueLen of the forbidden attributes approperiately
    ...
    /// Uses a an object type sepcific copy operation to return a copy
    ...
    /// Finds the appropriate object factory for teh derivation template
