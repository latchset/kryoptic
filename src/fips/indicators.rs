...
impl ValidationFactory {
    fn new() -> ValidationFactory {
        ...
        data.attributes.push(attr_element!(CKA_VALIDATION_TYPE; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_ulong; val 0));
        data.attributes.push(attr_element!(CKA_VALIDATION_VERSION; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_bytes; val Vec::new()));
        data.attributes.push(attr_element!(CKA_VALIDATION_LEVEL; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_ulong; val 0));
        data.attributes.push(attr_element!(CKA_VALIDATION_MODULE_ID; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_string; val String::new()));
        data.attributes.push(attr_element!(CKA_VALIDATION_FLAG; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_ulong; val 0));
        data.attributes.push(attr_element!(CKA_VALIDATION_AUTHORITY_TYPE; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_ulong; val 0));
        data.attributes.push(attr_element!(CKA_VALIDATION_COUNTRY; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_string; val String::new()));
        data.attributes.push(attr_element!(CKA_VALIDATION_CERTIFICATE_IDENTIFIER; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_string; val String::new()));
        data.attributes.push(attr_element!(CKA_VALIDATION_CERTIFICATE_URI; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_string; val String::new()));
        data.attributes.push(attr_element!(CKA_VALIDATION_VENDOR_URI; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_string; val String::new()));
        data.attributes.push(attr_element!(CKA_VALIDATION_PROFILE; OAFlags::AlwaysRequired | OAFlags::NeverSettable | OAFlags::Unchangeable; from_string; val String::new()));
