...
///
/// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203476](AES secret key objects)
/// (Version 3.1)
///
...
impl ObjectFactory for AesKeyFactory {
    /// Creation of AES keys use the default geenric secret creation
...
impl Mechanism for AesMechanism {
    ...
    ///
    /// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203477](AES key generation)
    /// (Version 3.1)
    ...
    ///
    /// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203510](AES Key Wrap)
    /// (Version 3.1)
    ...
    ///
    /// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203514](Key derivation by data encryption – DES & AES)
    /// (Version 3.1)
    ...
    /// Implements public AES MAC/CMAC operation (Sign)
    ///
    /// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203484](AES MAC)
    /// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203500](AES CMAC)
    /// (version 3.1)
    ...
    /// Implements public AES MAC/CMAC operations (Verify)
    ///
    /// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203484](AES MAC)
    /// [https://docs.oasis-open.org/pkcs11/pkcs11-spec/v3.1/os/pkcs11-spec-v3.1-os.html#_Toc111203500](AES CMAC)
    /// (version 3.1)
