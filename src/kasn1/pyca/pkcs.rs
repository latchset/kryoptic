/* The following code is copied and derived from:
 * https://github.com/pyca/cryptography/
 * File Path: src/rust/cryptography-x509/src/common.rs
 */
...
impl<T, U> Asn1ReadableOrWritable<T, U> {
    ...
    pub fn unwrap_read(&self) -> &T {
        match self {
            ...
            Asn1ReadableOrWritable::Write(_) => {
                panic!("unwrap_read called on a Write value")
            }
        }
    }
}
...
// }
#[derive(
    asn1::Asn1Read, asn1::Asn1Write, Clone, PartialEq, Eq, Debug, Hash,
)]
...
#[derive(
    asn1::Asn1Read, asn1::Asn1Write, Hash, Clone, PartialEq, Eq, Debug,
)]
...
mod tests {
    ...
    use super::{
        Asn1ReadableOrWritable, RawTlv, UnvalidatedVisibleString, WithTlv,
    };
