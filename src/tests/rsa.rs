...
fn test_rsa_mechs() {
    ...
    for mech in [
        #[cfg(not(any(feature = "no_sha1", feature = "fips")))]
        (CKM_SHA1_RSA_PKCS, None),
        (CKM_SHA224_RSA_PKCS, None),
        (CKM_SHA256_RSA_PKCS, None),
        (CKM_SHA384_RSA_PKCS, None),
        (CKM_SHA512_RSA_PKCS, None),
        #[cfg(not(any(feature = "no_sha1", feature = "fips")))]
