...
static HASH_MECH_SET: [(CK_MECHANISM_TYPE, CK_MECHANISM_TYPE, usize); 9] = [
    (CKM_SHA_1, CKM_SHA1_KEY_DERIVATION, 20),
    (CKM_SHA224, CKM_SHA224_KEY_DERIVATION, 24),
    (CKM_SHA256, CKM_SHA256_KEY_DERIVATION, 32),
    (CKM_SHA384, CKM_SHA384_KEY_DERIVATION, 48),
    (CKM_SHA512, CKM_SHA512_KEY_DERIVATION, 64),
    (CKM_SHA3_224, CKM_SHA3_224_KEY_DERIVATION, 24),
    (CKM_SHA3_256, CKM_SHA3_256_KEY_DERIVATION, 32),
    (CKM_SHA3_384, CKM_SHA3_384_KEY_DERIVATION, 48),
    (CKM_SHA3_512, CKM_SHA3_512_KEY_DERIVATION, 64),
];
